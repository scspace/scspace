...
class Space_piano_room extends CI_Driver {
    ...
    public function validate(){
        ...
        if ( ! $this->is_valid_start_time($from, $to, 1)) return '피아노실은 적어도 예약 하루 전 오후 11시 59분까지 예약해야합니다.';

        if ( ! $this->is_valid_end_time($from, $to, 14)) return '피아노실은 예약 14일 전부터 예약할 수 있습니다.';
