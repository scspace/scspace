...
/**
 *
 * Individual Practice Room Class
 *
 * @author  Yujin Kim
 *
*/

class Space_individual_practice_room extends CI_Driver {
    ...
    public function validate(){
        ...
        if (count($days_covered) == 2) {
            ...
            $max_duration = // of first day
                7200
                - $this->time_used('individual_practice_room_1', $first_day)
                - $this->time_used('individual_practice_room_2', $first_day)
                - $this->time_used('individual_practice_room_3', $first_day);

            if ( ! $this->is_shorter($from, $second_day, $max_duration)) return '개인연습실은 하루에 최대 2시간까지 사용할 수 있습니다.';

            $max_duration = // of second day
                7200
            ...
            $max_duration = // of that specific day
                7200
                - $this->time_used('individual_practice_room_1', $day)
                - $this->time_used('individual_practice_room_2', $day)
                - $this->time_used('individual_practice_room_3', $day);
            if ( ! $this->is_shorter($from, $to, $max_duration)) return '개인연습실은 하루에 최대 2시간까지 사용할 수 있습니다.';
        }
