...
<main class="container">
    ...
    <div class="row h1-block">
        ...
        <div class="col-sm-9">
            ...
            <h3> 보증금 </h3>
            <p>
                예약이 승인되면 행사 <span class="soft-red">하루 전 21시</span>까지 보증금을 입금해야합니다. 사용 이후 뒷정리와 기물 파손 여부에 따라 보증금 환급 여부가 결정됩니다. 울림홀 보증금은 매월 15일, 30일에 반환됩니다
            </p>
            <table class="table">
              <thead>
                  <tr>
            ...
            <h4> 경고 1회가 누적된 경우 경고 부과일 이후의 두 학기(계절학기 포함)에 대하여 예약이 불가능하다. </h4>
