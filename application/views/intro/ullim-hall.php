...
<main class="container">
    ...
    <div class="row h1-block">
        ...
        <div class="col-sm-9">
            ...
            <p>
               전체 학내 구성원을 대상으로 하는 행사의 경우 이를 증빙할 수 있는 자료(홍보 포스터 등)를 행사 3일 전 오후 11시 59분까지 제시하여야 하며 제시하지 않은 경우 행사 취소 및 불이익이 가해질 수 있습니다.
            </p>
            ...
            <ul class="list-unstyled">
                ...
                <li>현재는
                    <span class="soft-red"><?=date('n',strtotime('+10 day +9 hour'))?>월 <?=date('j',strtotime('+10 day +9 hour'))?>일</span>부터
                    <span class="soft-red"><?=date('n',strtotime('+45 day +9 hour'))?>월 <?=date('j',strtotime('+45 day +9 hour'))?>일</span>까지의 예약이 가능합니다.
                </li>
                <li>
                    장비 사용 시 <span class="soft-red">근로학생</span>이 배정됩니다.
                    예약 승인 시 근로 장학생의 연락처가 제공되며 리허설과 행사에서 도움을 받을 수 있습니다.
                    주말의 경우에는 근로 장학생에게 시간당 15,000원의 수당을 지급해야합니다.
                </li>
            ...
            <h4> 장비 미사용 시 </h4>
            <ul class="list-unstyled">
                <li>사용 45일 전부터 2일 전 오후 11시 59분까지 예약이 가능합니다.</li>
                <li>현재는
            ...
            <h3> 보증금 </h3>
            <p>
                예약이 승인되면 행사 <span class="soft-red">하루 전 오후 9시</span>까지 보증금을 입금해야합니다. 사용 이후 뒷정리와 기물 파손 여부에 따라 보증금 환급 여부가 결정됩니다. 울림홀 보증금은 매월 15일, 30일에 반환됩니다. 보증금 환급은 통상적으로 7일정도 소요됩니다.
            </p>
            <table class="table">
              <thead>
                  <tr>
            ...
            <ul class="list-unstyled">
                ...
                <li> 경고 1회가 누적된 경우 경고 부과일 이후의 두 학기(계절학기 포함)에 대하여 예약이 불가능하다 </li>
