    ...
    <div class="row h1-block">
        ...
        <div class="col-sm-9">
            ...
            <p>
                ...
                정기예약의 취소는 <span class="soft-red">사용 3일 전 오후 11시 59분</span>까지 학생문화공간위원회에 알려야합니다. <br>
            ...
            <ul class="list-unstyled">
                ...
                <li> 세미나실 내부 설비 고의 파손 및 안전상의 문제를 야기할 수 있는 행위을 할 경우 </li>
                <li> 그 외 학생문화공간위원회가 타인에게 피해를 주는 행위 혹은 악의적인 행위라고 판단될 경우 </li>
            </ul>
            <h4> 주의 2회가 누적된 경우, 경고 1회로 대체한다. </h4>
            <h4> 경고 1회가 누적된 경우 경고 부과일로부터 30일 동안 해당 공간의 예약이 불가하다. 정기예약의 경우 해당 학기 정기예약이 취소된다. </h4>
