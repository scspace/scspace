    ...
    <div class="row h1-block">
        ...
        <div class="col-sm-9">
            ...
            <ul class="list-unstyled">
                ...
                <li> 현재는 
                    <span class="soft-red"><?=date('n',strtotime('+1 day +9 hour'))?>월 <?=date('j',strtotime('+1 day +9 hour'))?>일</span>부터
                    <span class="soft-red"><?=date('n',strtotime('+14 day +9 hour'))?>월 <?=date('j',strtotime('+14 day +9 hour'))?>일</span>까지의 예약만 가능합니다.
                </li>
