...
<main class="container">
    ...
    <div class="row h1-block">
        ...
        <div class="col-sm-9">
            ...
            <h4> 예약 가능 시간 </h4>
            <ul class="list-unstyled">
                <li>사용 14일 전부터 이틀 전 21:00까지 예약이 가능합니다.</li>
            ...
            <h4> 경고 1회가 누적된 경우 해당 학기(정규학기 기준)동안 해당 공간의 예약이 불가하다. </h4>
            <h4> 경고 2회가 누적된 경우 해당 학기를 포함한 두 학기(정규학기 기준)동안 동안 해당 공간의 예약이 불가하다. </h4>
            <h4> 경고 및 주의는 매년 가을학기 종강일을 기준으로 초기화된다. </h4>
        </div>
    </div>
