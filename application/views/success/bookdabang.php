...
if ($reservation['space'] !== 'bookdabang') show_404();
...
<main class="container">
    <div class="form-horizontal form col-sm-8 col-sm-offset-2">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"> 홍보 방법 </label>
            <div class="col-sm-9">
                <p class="form-control-static"> <?=$content['promote']?> </p>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <p class="form-control-static"> <?php foreach($content['type_equipment'] as $equip) echo $equip.'<br>'?> </p>
            </div>
        </div>
        <?php endif;?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <a href="/bookdabang/delete/<?=$reservation['id']?>" type="button" class="btn btn-danger"> 예약 취소 </a>
                  </div>
                </div>
              </div>
            </div>
