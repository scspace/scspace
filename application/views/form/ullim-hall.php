    ...
    <form novalidate name="form" class="form-horizontal" action="/reservation/reserve/ullim-hall" method="post">
        ...
        <section class="form-section">
            ...
            <div class="form-group has-feedback" ng-class="{'has-error':form['time[rehearsal_from]'].$touched && form['time[rehearsal_from]'].$invalid || form['time[rehearsal_to]'].$touched && form['time[rehearsal_to]'].$invalid}">
                ...
                <div class="col-sm-4">
                    <input ng-model="time_rehearsal_from" type="datetime-local" name="time[rehearsal_from]" min="{{dateAfter(3) | date:'yyyy-MM-ddTHH:mm'}}" max = "{{dateAfter(45) | date:'yyyy-MM-ddTHH:mm'}}" placeholder="{{dateAfter(3) | date:'yyyy-MM-ddTHH:mm'}}" class="form-control time_from">
                ...
                <div class="col-sm-4">
                    <input ng-model="time_rehearsal_to" type="datetime-local" name="time[rehearsal_to]" min="{{dateAfter(3) | date:'yyyy-MM-ddTHH:mm'}}" max = "{{dateAfter(45) | date:'yyyy-MM-ddTHH:mm'}}" placeholder="{{dateAfter(44) | date:'yyyy-MM-ddTHH:mm'}}" class="form-control time_to">
                ...
                <span class="help-block col-sm-offset-2 col-sm-10" ng-show="form['time[rehearsal_from]'].$error.min || form['time[rehearsal_from]'].$error.max || form['time[rehearsal_to]'].$error.min || form['time[rehearsal_to]'].$error.max"> 현재 울림홀 행사의 리허설은 {{dateAfter(3) | date:'MM월 dd'}}일에서 {{dateAfter(44) | date:'MM월 dd'}}일까지 가능합니다. </span>
            </div>
            ...
            <div class="form-group has-feedback" ng-class="{'has-error':form['time[from]'].$touched && form['time[from]'].$invalid || form['time[to]'].$touched && form['time[to]'].$invalid}">
                ...
                <div class="col-sm-4">
                    <input ng-model="time_from" type="datetime-local" name="time[from]" min="{{dateAfter(3) | date:'yyyy-MM-ddTHH:mm'}}" max = "{{dateAfter(45) | date:'yyyy-MM-ddTHH:mm'}}" placeholder="{{dateAfter(3) | date:'yyyy-MM-ddTHH:mm'}}" class="form-control time_from" required>
                ...
                <div class="col-sm-4">
                    <input ng-model="time_to" type="datetime-local" name="time[to]" min="{{dateAfter(3) | date:'yyyy-MM-ddTHH:mm'}}" max = "{{dateAfter(45) | date:'yyyy-MM-ddTHH:mm'}}" placeholder="{{dateAfter(44) | date:'yyyy-MM-ddTHH:mm'}}" class="form-control time_to" required>
                ...
                <span class="help-block col-sm-offset-2 col-sm-10" ng-show="form['time[from]'].$error.min || form['time[from]'].$error.max || form['time[to]'].$error.min || form['time[to]'].$error.max"> 현재 울림홀 행사는 {{dateAfter(3) | date:'MM월 dd'}}일에서 {{dateAfter(44) | date:'MM월 dd'}}일까지 예약 가능합니다. </span>
            </div>
        </section>
