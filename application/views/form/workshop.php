...
<main class="container" ng-app="form" ng-controller="FormController">
	...
	<div class="form-group">
        ...
        <p class="col-sm-offset-2">
            <span class="glyphicon glyphicon-exclamation-sign"></span> 창작공방은 하루에 최대 3시간까지 사용할 수 있습니다.
        </p>
        <div class="form-group">
            <label for="space" class="col-sm-2 control-label"> 장소 </label>
            <div class="col-sm-10">
                <label class="radio-inline">
                    <input type="radio" ng-model="space" name="space" value="workshop" required> 창작공방
                </label>
            </div>
        </div>
        ...
        <div class="form-group has-feedback" ng-class="{'has-error':form.time_from.$touched && form.time_from.$invalid || form.time_to.$touched && form.time_to.$invalid}">
            ...
            <span class="help-block col-sm-offset-2 col-sm-10" ng-show="form.time_from.$error.min || form.time_from.$error.max || form.time_to.$error.min || form.time_to.$error.max"> 현재 창작공방은 {{dateAfter(2) | date:'MM월dd'}}일에서 {{dateAfter(14) | date:'MM월dd'}}일까지 빌릴 수 있습니다. </span>
        </div>
