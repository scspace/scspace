    ...
    <form novalidate name="form" class="form-horizontal" action="/reservation/reserve/mirae-hall" method="post">
        ...
        <section class="form-section">
            ...
            <div class="form-group has-feedback" ng-class="{'has-error':form['time[rehearsal_before_from]'].$touched && form['time[rehearsal_before_from]'].$invalid || form['time[rehearsal_before_to]'].$touched && form['time[rehearsal_before_to]'].$invalid}">
                ...
                <div class="col-sm-4">
                    <input ng-model="time_rehearsal_before_from" type="datetime-local" name="time[rehearsal_before_from]" min="{{dateAfter(10) | date:'yyyy-MM-ddTHH:mm'}}" max = "{{dateAfter(100, true) | date:'yyyy-MM-ddTHH:mm'}}" placeholder="{{dateAfter(1) | date:'yyyy-MM-ddTHH:mm'}}" class="form-control time_from">
                ...
                <div class="col-sm-4">
                    <input ng-model="time_rehearsal_before_to" type="datetime-local" name="time[rehearsal_before_to]" min="{{dateAfter(10) | date:'yyyy-MM-ddTHH:mm'}}" max = "{{dateAfter(100, true) | date:'yyyy-MM-ddTHH:mm'}}" placeholder="{{dateAfter(100) | date:'yyyy-MM-ddTHH:mm'}}" class="form-control time_to">
            ...
            <div class="form-group has-feedback" ng-class="{'has-error':form['time[rehearsal_from]'].$touched && form['time[rehearsal_from]'].$invalid || form['time[rehearsal_to]'].$touched && form['time[rehearsal_to]'].$invalid}">
                ...
                <div class="col-sm-4">
                    <input ng-model="time_rehearsal_from" type="datetime-local" name="time[rehearsal_from]" min="{{dateAfter(10) | date:'yyyy-MM-ddTHH:mm'}}" max = "{{dateAfter(100, true) | date:'yyyy-MM-ddTHH:mm'}}" placeholder="{{dateAfter(2) | date:'yyyy-MM-ddTHH:mm'}}" class="form-control time_from">
                ...
                <div class="col-sm-4">
                    <input ng-model="time_rehearsal_to" type="datetime-local" name="time[rehearsal_to]" min="{{dateAfter(10) | date:'yyyy-MM-ddTHH:mm'}}" max = "{{dateAfter(100, true) | date:'yyyy-MM-ddTHH:mm'}}" placeholder="{{dateAfter(100) | date:'yyyy-MM-ddTHH:mm'}}" class="form-control time_to">
                ...
                <span class="help-block col-sm-offset-2 col-sm-10" ng-show="form['time[rehearsal_from]'].$error.min || form['time[rehearsal_from]'].$error.max || form['time[rehearsal_to]'].$error.min || form['time[rehearsal_to]'].$error.max"> 현재 울림홀 행사의 리허설은 {{dateAfter(2) | date:'MM월 dd'}}일에서 {{dateAfter(100) | date:'MM월 dd'}}일까지 가능합니다. </span>
            </div>
            ...
            <div class="form-group has-feedback" ng-class="{'has-error':form['time[from]'].$touched && form['time[from]'].$invalid || form['time[to]'].$touched && form['time[to]'].$invalid}">
                ...
                <div class="col-sm-4">
                    <input ng-model="time_from" type="datetime-local" name="time[from]" min="{{dateAfter(10) | date:'yyyy-MM-ddTHH:mm'}}" max = "{{dateAfter(100, true) | date:'yyyy-MM-ddTHH:mm'}}" placeholder="{{dateAfter(10) | date:'yyyy-MM-ddTHH:mm'}}" class="form-control time_from" required>
                ...
                <div class="col-sm-4">
                    <input ng-model="time_to" type="datetime-local" name="time[to]" min="{{dateAfter(10) | date:'yyyy-MM-ddTHH:mm'}}" max = "{{dateAfter(100, true) | date:'yyyy-MM-ddTHH:mm'}}" placeholder="{{dateAfter(100) | date:'yyyy-MM-ddTHH:mm'}}" class="form-control time_to" required>
                ...
                <span class="help-block col-sm-offset-2 col-sm-10" ng-show="form['time[from]'].$error.min || form['time[from]'].$error.max || form['time[to]'].$error.min || form['time[to]'].$error.max"> 현재 미래홀  행사는 {{dateAfter(10) | date:'MM월 dd'}}일에서 {{dateAfter(100) | date:'MM월 dd'}}일까지 예약 가능합니다. </span>
            </div>
        </section>
        ...
        <section class="form-section">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="checkbox">
                        <label>
			                <input ng-model="usage_equipment" type="checkbox" name="usage_equipment" value="yes" onClick= "checkequip();"> 장비를 사용합니다.
                        </label>
                    </div>
                </div>
