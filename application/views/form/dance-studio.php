    ...
    <form novalidate name="form" class="form-horizontal" action="/reservation/reserve/<?=$space?>" method="post">
        ...
        <section>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <span class="help-block" style="margin-bottom:4px;"> <span class="glyphicon glyphicon-exclamation-sign"></span> 만약 소속된 팀이 없다면 <a href='/dance-studio/team-register'>팀을 등록</a>하세요.</span>
                </div>
            </div>
        ...
        <section>
            ...
            <p class="col-sm-offset-2">
                <span class="glyphicon glyphicon-exclamation-sign"></span> 무예실은 하루에 최대 2시간까지 사용할 수 있습니다.
            </p>
            <div class="form-group has-feedback" ng-class="{'has-error':form.time_from.$touched && form.time_from.$invalid || form.time_to.$touched && form.time_to.$invalid || (isValidTime == 'invalid'),'has-warning':(isValidTime == 'warning')||responseError == 'true' }">
                ...
                <span class="help-block col-sm-offset-2 col-sm-10" ng-show="form.time_from.$error.min || form.time_from.$error.max || form.time_to.$error.min || form.time_to.$error.max"> 현재 무예실은 {{dateAfter(2) | date:'MM월 dd'}}일에서 {{dateAfter(14) | date:'MM월 dd'}}일까지 빌릴 수 있습니다. </span>
            </div>
        </section>
