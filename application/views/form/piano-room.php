...
<main class="container" ng-app="form" ng-controller="FormController">
	...
	<div class="form-group">
        ...
        <div class="form-group has-feedback" ng-class="{'has-error':form.time_from.$touched && form.time_from.$invalid || form.time_to.$touched && form.time_to.$invalid || (isValidTime == 'invalid'),'has-warning':responseError == 'true','has-success':validity}">
            ...
            <div class="col-sm-4">
                <input ng-model="time_from" type="datetime-local" name="time_from" min="{{dateAfter(1) | date:'yyyy-MM-ddTHH:mm'}}" max="{{dateAfter(14, true) | date:'yyyy-MM-ddTHH:mm'}}" placeholder="{{dateAfter(1) | date:'yyyy-MM-ddTHH:mm'}}" class="form-control time_from" required>
            ...
            <div class="col-sm-4">
                <input ng-model="time_to" type="datetime-local" name="time_to" min="{{dateAfter(1) | date:'yyyy-MM-ddTHH:mm'}}" max="{{dateAfter(14, true) | date:'yyyy-MM-ddTHH:mm'}}" placeholder="{{dateAfter(14) | date:'yyyy-MM-ddTHH:mm'}}" class="form-control time_to" required>
