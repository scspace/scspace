    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label"> 테이블 </label>
                    <div class="col-sm-9">
                        <p class="form-control-static"> <?=$content['no_table']?>개 </p>

                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label"> 의자 </label>
                    <div class="col-sm-9">
                        <p class="form-control-static"> <?=$content['no_chair']?>개 </p>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <?php if($content['1f_lobby'] == 'yes'):?>
                        <p class="form-control-static"> 1층 로비를 사용합니다. </p>
                        <?php else:?>
                        <p class="form-control-static"> 1층 로비를 사용하지 않습니다. </p>
                        <?php endif;?>
                    </div>
                </div>
